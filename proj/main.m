...
void animateImage (const char* gracePathString, const char* sparklePathString) {
    NSString *graceImagePath = [NSString stringWithFormat: @"%s" , gracePathString];
    ...
    // NSString *imagePath = [folder stringByAppendingPathComponent:@"grace.png"];
    // NSString *sparklePath = [folder stringByAppendingPathComponent:@"heygurl.png"];

    CGSize imageSize = getImageSize(graceImagePath);
    CGImageRef cgimage = createCGImage(graceImagePath);
